...
class Dim_red_PCA(object):
    ...
    def view_variance(self, data, suffix, n_threshold):
...
if __name__ == "__main__":
    ...
    first_pca.view_variance(data, suffix, n_threshold)
    ...
    view_tool.view_vs_target(data_pca_dim2, target, suffix, "pca_target")
    ...
    view_tool.view_vs_target(data_tsne_dim2, target, suffix, "tsne_target")
